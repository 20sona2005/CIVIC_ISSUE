 ...
 * Features:
 *  • Full paginated list, newest first
 *  • Filter tabs: All | Unread
 *  • Mark individual notification as read on click
 *  • Mark All as Read button
 *  • Click navigates to related issue
    ...
    >
      ...
      <div className="notif-card__content">
        <div className="notif-card__top">
          ...
          {!notif.isRead && (
            <span className="notif-card__new-badge">New</span>
          )}
        </div>
        ...
        {notif.issueTitle && (
          <p className="notif-card__issue">
            <span className="notif-card__issue-label">Issue:</span>
            {' '}{notif.issueTitle}
            {notif.issueCategory && (
              <span className="notif-card__category-tag">{notif.issueCategory}</span>
            )}
          </p>
        )}
        ...
        {notif.issueId && (
          <span className="notif-card__cta">View Issue →</span>
        )}
      </div>
    </div>
  );
    ...
    <div className="container">
      ...
      <div className="notif-page-tabs">
        ...
        >
          Unread
          {unreadCount > 0 && (
            <span className="notif-tab-count notif-tab-count--red">{unreadCount}</span>
          )}
        </button>
      </div>
      ...
      {!loading && notifications.length === 0 && (
        <div className="empty-state" style={{ minHeight: '50vh' }}>
          ...
          <p>You'll be notified here when issues are reported or updated.</p>
        </div>
      )}
      ...
      {!loading && tab === 'unread' && unreadCount === 0 && notifications.length > 0 && (
        <div className="empty-state" style={{ minHeight: '40vh' }}>
          ...
          <button className="btn btn-outline" onClick={() => setTab('all')}>
